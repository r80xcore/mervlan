...
require functions/update_mervlan_repair.sh 'trap repair_exit_handler EXIT' 'repair lacks private temporary workspace cleanup'
require functions/update_mervlan_repair.sh "trap 'repair_signal_handler 129' HUP" 'repair lacks HUP cleanup'
require functions/update_mervlan_repair.sh "trap 'repair_signal_handler 130' INT" 'repair lacks INT cleanup'
require functions/update_mervlan_repair.sh "trap 'repair_signal_handler 143' TERM" 'repair lacks TERM cleanup'
